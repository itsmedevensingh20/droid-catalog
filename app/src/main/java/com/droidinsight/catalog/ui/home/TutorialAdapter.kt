...
import kotlinx.android.synthetic.main.layout_tutorial_grid.view.*
    ...
    inner class TutorialViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(position: Int) {
            ...
            Glide.with(view.context)
                ...
                .into(view.tutorialImage)

            view.tutorialText.text = mResponse[position].top_post_link
